...
Computer Science (AI & Data Science) student focused on backend engineering, open-source software, and building practical solutions through code.
...
| ------------------------------ | --------------------------------------------------- |
| **Backend Systems**            | Node.js • Express.js • REST APIs • JWT              |
| **Frontend Applications**      | React • HTML • CSS • Bootstrap                      |
| **Databases**                  | PostgreSQL • MongoDB • Firebase                     |
| **AI & Machine Learning**      | TensorFlow • Scikit-learn • OpenCV • Pandas • NumPy |
| **Infrastructure & Dev Tools** | Docker • Redis • Celery • Git • AWS • Postman       |
...
🌐 <a href="https://madhuriportfolio-mocha.vercel.app">Portfolio</a> •
💼 <a href="https://linkedin.com/in/madhuri-perumalla-5a8919330">LinkedIn</a> •
📧 <a href="mailto:madhurisriperumalla@gmail.com">Email</a>
